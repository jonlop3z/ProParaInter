...
@endif
    ...
    <form action="{{ action('UserController@store')}}" method="POST">
      ...
      <input class="form-control" type = "password" name="password_confirmation" placeholder="Introduzca su contraseña required">
      </div>
      
      <button type="submit" class="btn btn-confirm">Aceptar</button>
